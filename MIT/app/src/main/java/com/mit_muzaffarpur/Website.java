...
public class Website extends AppCompatActivity {
    ...
    WebView webView;
    private String webUrl = "https://www.mitmuzaffarpur.org";
...
//        window.addFlags(WindowManager.LayoutParams.FLAGS_CHANGED);
        ...
        progressDialog.setMessage("MIT MUZZAFARPUR\n\nLoading Please Wait...");
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(Website.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(Website.this, "Downloading File..", Toast.LENGTH_SHORT).show();
